      ...
      */
      ...
      let SkyBox = new THREE.CubeTextureLoader().load(
       ...
       const textureLoader = new THREE.TextureLoader();
				...
				const textureFlare0 = textureLoader.load( '/models3d/textures/lensflare0.png' );
				const textureFlare3 = textureLoader.load( '/models3d/textures/lensflare3.png' );
       ...
       loadFbx01.load( '/models3d/artifact_ring/artifact_medium_ring_01.fbx', function ( object01 ) {
       ...
       loadFbx02.load( '/models3d/homi/homi_3d_02.fbx', function ( object02 ) {
            ...
            /** LOAD GLF  */
              ...
              const modelPath = '/models3d/artifact_ring_anim/ring_power_conscientiamstudios.glb';
